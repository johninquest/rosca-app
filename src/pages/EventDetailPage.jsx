  ...
  return (
    <div className="min-h-dvh bg-[#F9F9F9]">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
                ...
                <li key={c.id} className="px-5 py-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="min-w-0">
                      <p className="text-sm font-medium text-[#1A1A1A] truncate">{c.contributorName}</p>
                      <p className="text-xs text-[#888888] mt-0.5">
                        <span className="font-mono">{formatAmount(c.amount, event.currency)}</span>
        ...
        {/* Management card */}
        <div className="bg-white border border-[#E0E0E0] rounded-lg p-5 flex flex-wrap gap-2">
          {/* WhatsApp — visible to everyone */}
          <button
            type="button"
            onClick={handleWhatsApp}
